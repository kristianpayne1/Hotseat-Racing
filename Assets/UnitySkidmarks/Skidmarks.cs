...
public class Skidmarks : MonoBehaviour {
	...
	const float MARK_WIDTH = 0.25f; // Width of the skidmarks. Should match the width of the wheels
	const float GROUND_OFFSET = 0.02f;  // Distance above surface in metres
	const float MIN_DISTANCE = 1f; // Distance between skid texture sections in metres. Bigger = better performance, less smooth
